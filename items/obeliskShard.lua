...
local sprite = Resources.sprite_load("aphelion", "obeliskShard", PATH.."assets/sprites/obeliskShard.png", 1, 16, 16)
...
local sprite = Resources.sprite_load("aphelion", "buffObeliskShard", PATH.."assets/sprites/buffObeliskShard.png", 1, 7, 8)
