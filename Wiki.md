...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td align="center"><p>Slowly increase $\color{#efd27b}\textsf{damage}$, $\color{#efd27b}\textsf{attack speed}$, $\color{#319ad2}\textsf{movement speed}$, $\color{#efd27b}\textsf{critical chance}$, $\color{#7eb686}\textsf{health regeneration}$, and $\color{#7eb686}\textsf{armor}$ while in combat, up to $\color{#efd27b}\textsf{7\%}$ $\color{#555555}\textsf{(+3.5\% per stack)}$ $\color{#efd27b}\textsf{multiplicatively}$ after $\color{#efd27b}\textsf{25}$ seconds. $\color{#cf6666}\textsf{Expires}$ after $\color{#cf6666}\textsf{not striking an enemy}$ for $\color{#efd27b}\textsf{5}$ seconds.</p></td>
        </tr>
    </tbody>
    <tbody>
        <tr>
