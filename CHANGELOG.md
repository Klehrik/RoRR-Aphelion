...
* Phi Construct
    * Made movement behavior and animation more dynamic
    * Emits sparks vfx generally, and other particles when firing
    * Added sfx when firing
    * Base fire rate: 0.8s -> 0.7s
    * Base damage: 60% -> 70%
