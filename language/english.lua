return {
    item = {
        ...
        explosiveSpear = {
            ...
            description = "Throw an <r>explosive spear</c> on a hit that deals <b>at least 200% damage</c>, <y>stunning</c> an enemy for <y>3x16% <c_stack>(+8% per stack) <y>TOTAL damage</c> and <y>exploding</c> for <y>200% <c_stack>(+100% per stack) <y>TOTAL damage</c> after a short delay. Has a <b>10 second</c> cooldown.",
