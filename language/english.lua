return {
    item = {
        ...
        explosiveSpear = {
            ...
            description = "Throw an <r>explosive spear</c> on a hit that deals <b>at least 200% damage</c>, <y>stunning</c> an enemy for <y>3x30% <c_stack>(+30% per stack) <y>damage</c> and <y>exploding</c> for <y>100% <c_stack>(+50% per stack) <y>TOTAL damage</c> after a short delay. Has a <b>10 second</c> cooldown.",
