...
local sprite = Resources.sprite_load(_ENV["!plugins_mod_folder_path"].."/plugins/assets/sprites/rottingBranch.png", 1, false, false, 16, 16)
...
local sprite = Resources.sprite_load(_ENV["!plugins_mod_folder_path"].."/plugins/assets/sprites/buffRottingBranch.png", 1, false, false, 12, 12)
