...
local sprite = Resources.sprite_load(_ENV["!plugins_mod_folder_path"].."/plugins/assets/sprites/ballisticVest.png", 1, false, false, 16, 16)
...
Item.add_callback(item, "onPickup", function(actor, stack)
    ...
    actor.maxshield_base = actor.maxshield_base + 15
end)
