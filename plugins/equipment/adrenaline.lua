...
local sprite = Resources.sprite_load(PATH.."assets/sprites/adrenaline.png", 2, 22, 22)
...
local sprite = Resources.sprite_load(PATH.."assets/sprites/buffAdrenaline.png", 1, 7, 5)
